...
Ce module fournit une interface pour interagir avec l'API Kraken. Pas besoin
de clef API puor les données publiques sur Kraken.
"""
...
class KrakenClient:
    """
    Client pour interagir avec l'API Kraken. Pour les données de marché
    publiques, aucune clé API n'est nécessaire.
    ...
    def _check_exchange_initialization(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Échec de l'initialisation de l'exchange Kraken: {e}") from e
