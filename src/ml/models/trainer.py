"""XGBoost model trainer with MLflow experiment tracking.

Temporal train/test splits only — NEVER random splits for time-series data.
"""
...
class ModelTrainer:
    """Train XGBoost classifiers with MLflow tracking.
    ...
    def __init__(self, experiment_name: str) -> None:
        ...
        logger.info("ModelTrainer initialised — experiment: %s", experiment_name)
    ...
    def temporal_split(
        ...
        The split is strictly chronological: training data always precedes
        test data. NEVER use random splitting on time-series data.
