...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("price_open", sa.Numeric(30, 8), nullable=False),
        sa.Column("price_high", sa.Numeric(30, 8), nullable=False),
        sa.Column("price_low", sa.Numeric(30, 8), nullable=False),
        sa.Column("price_close", sa.Numeric(30, 8), nullable=False),
