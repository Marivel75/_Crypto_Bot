...
class PipelineResult:
    ...
    Attributs:
        ...
        timeframe: Timeframe
        success: Booléen qui indique si le pipeline a réussi, False initialement
        ...
        transformed_rows: Nombre de lignes après transformation
        loaded_rows: Nombre de lignes chargées dans la base
        error: Message d'erreur
        error_step: Étape où l'erreur s'est produite
    """
